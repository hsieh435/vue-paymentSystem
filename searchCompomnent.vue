        ...
        axios
          ...
          .then((response) => {
            ...
            for (let i = 0; i < searchResult.length; i++) {
              const eachuserNotesId = searchResult[i].userInfo.notesId;
              // console.log("eachuserNotesId:", eachuserNotesId);

              const eachuserName = searchResult[i].userInfo.userName;
              // console.log("eachuserName:", eachuserName);

              // users["notesId"] = eachuserNotesId;
              // users["userName"] = eachuserName;
              // console.log("users:", users);

              // users.push(eachuserNotesId);
              // users.push(eachuserName);
              // console.log("users:", users);
